...
function showFusion(elementId, fusionId, elementFusionId){
    ...
    fusionUrl = "https://raw.githubusercontent.com/rohitkesharwani9/custom-fusion-sprites/main/CustomBattlers/" + fusionId;
    ...
    if(doesImageExists(fusionUrl)){
        ...
        fallbackFusionRepository = "https://raw.githubusercontent.com/rohitkesharwani9/autogen-fusion-sprites/master/Battlers/"
...
function showShinies(randomHead, randomBody){
    ...
    picShinySrc = "https://raw.githubusercontent.com/rohitkesharwani9/custom-fusion-sprites/main/CustomBattlers/" + (headId+1) + "." + (bodyId+1) + ".png";

    if (!doesImageExists(picShinySrc)) {
        picShinySrc = "https://raw.githubusercontent.com/rohitkesharwani9/autogen-fusion-sprites/master/Battlers/" + (headId+1) + "/" + (headId+1) + "." + (bodyId+1) + ".png";
